...
#ifndef HARDWARESERIAL_LCD_H
#define HARDWARESERIAL_LCD_H

#include <inttypes.h>
#include <Arduino.h>

/* We remove the Software Serial for STM32 Boards */
...
class HardwareSerialLCD : public HardwareSerial{
public:

    HardwareSerialLCD(uint8_t, uint8_t);
    void begin();
    void clear();
    void home();
